# Motion-stream
Support for Infrared movement detection - part of  "Doorbell security camera" final course project.
1. mqtt_motion_stream.py - mqtt listener managed by service firing gst receiver/playback on received alert
